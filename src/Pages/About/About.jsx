...
import imgFena from '../../assets/img/Feña.png'
import imgDiego from '../../assets/img/Diego.png'
import imgGonza from '../../assets/img/Gonza.png'
import imgPipe from '../../assets/img/Pipe.png'
import imgMargo from '../../assets/img/Margo.png'
        ...
        <div className="container-fluid row developers-box display-flex p-0 m-0">
          <div className="developers-container col-md-12 col-lg-8">
            <div className="developer-person fernanda col-2">
              <img src={imgFena} className="developer-img" alt="Fernanda" />
            </div>
            <div className="developer-person diego col-2">
              <img src={imgDiego} className="developer-img" alt="Diego" />
            </div>
            <div className="developer-person gonzalo col-2">
              <img src={imgGonza} className="developer-img" alt="Gonza" />
            </div>
            <div className="developer-person felipe col-2">
              <img src={imgPipe} className="developer-img" alt="Pipe" />
            </div>
